        ...
        <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-orange-100 text-gray-800 overflow-x-hidden">
            ...
            <section className="relative text-center px-4 pt-20 pb-12 sm:pt-28 sm:pb-16">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="mt-4 text-lg sm:text-xl text-gray-700 max-w-2xl mx-auto">
                        Dive into Ancient Egypt and explore breathtaking 3D artifacts and historical treasures — right in your browser.
                    </p>
                    ...
                    {[
                        {
                            ...
                            desc: 'Study ancient artifacts in full 3D — rotate, zoom, and examine every detail.',
                            icon: '/images/3d.png',
                        },
                        {
                            title: 'Interactive Map',
                            desc: 'Click on locations throughout Egypt to see famous temples, pyramids, and ruins.',
                            icon: '/images/map-view.png',
                        },
                        {
                            title: 'Learn with Legends',
                            desc: 'Discover fascinating stories and cultural facts about each artifact from Ancient Egypt.',
            ...
            <section className="py-14 px-4 bg-yellow-100 text-center">
                ...
                <p className="text-gray-700 max-w-2xl mx-auto mt-4">
                    Our collection is based on real archaeological data, captivating visualization, and smooth 3D animation to transport you to the past.
                </p>
            ...
            <section className="py-16 px-6 bg-yellow-700 text-white text-center">
                ...
                <p className="mt-3 text-lg max-w-xl mx-auto">
                    Travel through 5000 years of history. Discover the wonders of Egypt without leaving your screen.
                </p>
                <Link
                    href="/artifacts"
            ...
            <footer className="text-center text-sm py-6 text-gray-600 bg-white">
                &copy; {new Date().getFullYear()} Egyptian Wonders. Created by Mark Albert for history enthusiasts.
            </footer>
        </div>
    )
}